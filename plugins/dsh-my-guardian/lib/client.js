...
`
    ...
    function EntryRow({ entry, source, onAction }) {
      ...
      return createElement('div', { className: 'dsh-my-guardian-row' },
        createElement('div', { className: 'dsh-my-guardian-row-head' },
          createElement('span', { className: 'dsh-my-guardian-source' }, source === 'staged' ? strings.staged() : strings.promoted()),
          createElement('span', { className: 'dsh-my-guardian-name', title: entry.id }, entry.name),
          createElement('span', { className: `dsh-my-guardian-badge dsh-my-guardian-${entry.status}` }, statusLabel(entry.status)),
        ),
        createElement('div', { className: 'dsh-my-guardian-row-meta' },
          createElement('span', null, entry.id),
          entry.attempts > 0 ? createElement('span', { className: 'dsh-my-guardian-attempts' }, `×${entry.attempts}`) : null,
        ),
        hasError
          ...
          : null,
        expanded && hasError
          ? createElement('pre', { className: 'dsh-my-guardian-error' }, entry.lastError)
          : null,
        createElement('div', { className: 'dsh-my-guardian-actions' },
    ...
    function SafeModeBar({ safeMode, onSafeMode }) {
      return createElement('div', { className: 'dsh-my-guardian-safemode' },
    ...
    function EntryList({ rows, onAction }) {
      ...
      return createElement('div', { className: 'dsh-my-guardian-list' },
    ...
    function EventList({ events }) {
      ...
      return createElement('div', { className: 'dsh-my-guardian-events' },
    ...
    function GuardianView({ visible }) {
      ...
      return createElement('div', { className: 'dsh-my-guardian-panel' },
