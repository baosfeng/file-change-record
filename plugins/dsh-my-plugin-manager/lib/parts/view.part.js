...
function InstalledSection({ installed, updates, actions }) {
  ...
  return createElement(
    ...
    installed === null ? createElement('div', { className: 'dpm-status' }, strings.loading()) : rows,
    createElement(
      'div',
...
function InstalledRow({ entry, outdated, onUninstall }) {
  return createElement(
    ...
    createElement(
      ...
      outdated !== null
        ? createElement('span', { className: 'dpm-ver dpm-new' }, `${outdated.current} → ${outdated.latest}`)
        : null,
      createElement('span', { className: 'dpm-state' }, entry.enabled ? strings.running() : strings.disabled()),
    ),
    createElement(
      'div',
      { className: 'dpm-actions' },
...
function MarketSection({ actions }) {
  ...
  return createElement(
    ...
    searching
      ? createElement('div', { className: 'dpm-status' }, strings.loading())
