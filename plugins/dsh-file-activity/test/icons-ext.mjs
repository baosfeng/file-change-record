...
const BRAND_FILLS = {
  ...
  ts: '#3178C6', mts: '#3178C6', cts: '#3178C6', tsx: '#3178C6', jsx: '#3178C6',
  // 后端语言
  java: '#007396',
  c: '#A8B9CC',
  cpp: '#00599C', cxx: '#00599C', cc: '#00599C', hpp: '#00599C',
  h: '#A8B9CC', hh: '#A8B9CC',
  cs: '#68217A', csharp: '#68217A',
  go: '#00ADD8',
  rs: '#CE422B',
  rb: '#B51624',
  php: '#777BB4',
  ...
  sql: '#00758F',
  csv: '#2E7D32',
  db: '#0F62FE', sqlite: '#0F62FE', sqlite3: '#0F62FE',
  xml: '#FF6F00', svg: '#FF6F00',
  // 文档
  md: '#42A5F5', markdown: '#42A5F5',
  txt: '#90A4AE', text: '#90A4AE', log: '#90A4AE',
  pdf: '#E5202B',
  ...
  toml: '#8D6E63',
  ini: '#546E7A', cfg: '#546E7A', config: '#546E7A',
  env: '#F9A825',
  properties: '#7B1FA2',
  lock: '#37474F',
  ...
  ps1: '#012456',
  bat: '#546E7A', cmd: '#546E7A',
  // 打包 / 二进制
  zip: '#FFA726', tar: '#FFA726', gz: '#FFA726', '7z': '#FFA726', rar: '#FFA726',
  exe: '#0078D4', msi: '#0078D4',
  wasm: '#654FF0',
  // 图片 / 媒体
  png: '#8E44AD', jpg: '#8E44AD', jpeg: '#8E44AD', gif: '#8E44AD', webp: '#8E44AD', ico: '#8E44AD', bmp: '#8E44AD',
  // 版本控制
...
test('new common-language groups carry their brand mark (issue #24)', () => {
  const expected = {
    java: 'JAVA', c: 'C', cpp: 'C++', cs: 'C#', go: 'GO', rs: 'RS', rb: 'RB',
    php: 'PHP', swift: 'SWIFT', kt: 'KT', dart: 'DART', scala: 'SCALA',
    sql: 'SQL', csv: 'CSV', db: 'DB', xml: 'XML', pdf: 'PDF', vue: 'VUE',
    zip: 'ZIP', exe: 'EXE', png: 'IMG', ps1: 'PS1', dockerfile: 'DOCK', ipynb: 'JNB',
  }
