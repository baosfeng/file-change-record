 ...
 * of lib/client.src.js and write lib/client.js — the single __ModuleLoader__
 * bundle DSH actually serves.
 *
...
/** (placeholder, part file) in splice order — const initializers depend on it. */
const pieces = [
  ['__PART_I18N__', 'i18n.part.js'],
  ['__PART_FORMAT__', 'format.part.js'],
  ['__PART_TREE__', 'tree.part.js'],
  ['__PART_STORE__', 'store.part.js'],
  ['__PART_API__', 'api.part.js'],
  ['__PART_INTERCEPTOR__', 'interceptor.part.js'],
  ['__PART_AUTO_OPEN__', 'auto-open.part.js'],
  ['__PART_ICONS__', 'icons.part.js'],
  ['__PART_STYLES__', 'styles.part.js'],
  ['__PART_ROWS__', 'rows.part.js'],
  ['__PART_VIEW__', 'view.part.js'],
  ['__PART_PREVIEW__', 'preview.part.js'],
